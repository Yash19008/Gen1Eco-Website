    ...
    >
      ...
      <div className="fpc-info">
        ...
        <div className="fpc-stars">
          {[...Array(5)].map((_, i) => (
            <FaStar key={i} size={16} color={i < getProductRatingStars(product) ? "#5e6266" : "#ddd"} />
          ))}
    ...
    <>
      <style>{`
        ...
        @media (max-width: 834px) {
          .fp-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; }
