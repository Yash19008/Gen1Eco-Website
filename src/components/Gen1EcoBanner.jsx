...
const Gen1EcoBanner = () => {
  ...
  const styles = `
    ...
    @media (max-width: 1024px) {
      .eco-wrapper { gap: 20px; min-height: 420px; }
      ...
      .gen-eco-container { padding: 50px 20px; }
    }
    ...
    .gen-eco-container { padding: 60px 20px; }
  ...
  return (
    <>
      <style>{styles}</style>
      <div className="gen-eco-container" style={{ maxWidth: '1415px', margin: '0 auto' }}>
