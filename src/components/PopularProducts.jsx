  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 1024px) {
          .pp-grid { grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px; }
          .pp-section { padding: 50px 0; }
          .pp-header-left h3 { font-size: 28px; }
        }

        @media (max-width: 768px) {
          .pp-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px; }
          .pp-header-left h3 { font-size: 26px; }
          .pp-section { padding: 40px 0; }
        }

        @media (max-width: 480px) {
          .pp-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }
